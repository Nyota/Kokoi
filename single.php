<?php
/**
 * This template displays the single page.
 *
				...
				<div class="top">
					<div class="top-inner">
						...
						<main>
							...
							<?php
								/**
								 * Functions hooked in to koko_after_single_post
								 *
								 * @hooked koko_single_post_pagination - 10
								 */
								do_action( 'koko_after_single_post' ); ?>
							</div>
						</main>
					</div>
				</div>
